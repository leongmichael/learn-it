      ...
      >
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <Box sx={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            ...
            <FormControl variant="standard" sx={{ marginLeft: 1, minWidth: 80, color: '#7235FF' }}>
              <InputLabel id="playback-rate-label" sx={{ color: '#7235FF' }}>Speed</InputLabel>
              <Select
                labelId="playback-rate-label"
                id="playback-rate"
                value={playbackRate}
                onChange={handlePlaybackRateChange}
                sx={{ color: '#7235FF', '& .MuiSvgIcon-root': { color: '#7235FF' } }}
              >
